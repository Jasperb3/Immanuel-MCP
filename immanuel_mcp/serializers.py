"""Compact JSON serializer for chart output.

Runtime dependency of every compact_* tool. Lived in the gitignored scripts/
directory until it was removed from disk by 03c1809, which left the package
unimportable from a clean checkout; it belongs inside the package.
"""
